...
class Notification(models.Model):
    TYPE_CHOICES = [
        ...
        ('booking_otp_issued', 'Booking OTP Issued'),
        ('artist_on_the_way', 'Artist On The Way'),
        ('artist_arrived', 'Artist Arrived'),
        ('start_pin_ready', 'Start Service PIN Ready'),
        ('service_started', 'Service Started'),
        ('completion_pin_ready', 'Completion PIN Ready'),
