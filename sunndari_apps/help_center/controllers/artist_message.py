...
class ArtistMessageController:
    """Same underlying message logic as MessageController — see
    ArtistConversationController for why this is a separate route."""

    @extend_schema(
        description="List messages for the authenticated artist's support conversation (paginated).",
    ...
    @extend_schema(
        description=(
            ...
            "artist doesn't currently have an open one."
        ),
