...
class PaymentSerializer(serializers.Serializer):
    ...
    gateway = serializers.CharField(allow_null=True, allow_blank=True)
    gatewayOrderId = serializers.CharField(allow_null=True, allow_blank=True)
    gatewayPaymentId = serializers.CharField(allow_null=True, allow_blank=True)
    paidAt = serializers.DateTimeField(allow_null=True)
    failureReason = serializers.CharField(allow_null=True, allow_blank=True)
